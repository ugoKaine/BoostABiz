  ...
  receiptF.forEach((sale) => {
    Product.findOne({ title: sale.item })
      ...
      .then((result) => {
        ...
        pdfDoc
          .fontSize(20)
          .text(" Egbeda. Tel:08064585484", { align: "center" });

        // pdfDoc.fontSize(20).text("Receipt Details", 10, 120, {
        //   underline: true,
        // });

        pdfDoc.fontSize(20).text("Item", 20, 150, { width: 190 });
        pdfDoc.fontSize(20).text("Qty", 210, 150, { width: 100 });
        pdfDoc.fontSize(20).text("Price", 310, 150, { width: 100 });
        ...
        receipt.receiptField.forEach(function (sale) {
          ...
          pdfDoc.fontSize(17).text(sale.item, 20, y, { width: 190 });
          pdfDoc.text(sale.quantity, 210, y, { width: 100 });
          pdfDoc.fontSize(17).text(sale.price, 310, y, { width: 100 });
          pdfDoc.fontSize(17).text(sale.total, 410, y, { width: 190 });
          productNo++;
        });
        pdfDoc
