...
exports.postReceipt = (req, res, next) => {
  ...
  const pdfDoc = new PDFDocument({ margin: 5 });
  ...
  pdfDoc.fontSize(20).text("Item", 10, 150, { width: 250 });
  pdfDoc.fontSize(20).text("Qty", 260, 150, { width: 40 });
  pdfDoc.fontSize(20).text("Price", 300, 150, { width: 90 });
  pdfDoc.fontSize(20).text("Total Price", 390, 150, { width: 200 });
  ...
  receipt.receiptField.forEach(function (sale) {
    ...
    pdfDoc.fontSize(17).text(sale.item, 10, y, { width: 250 });
    pdfDoc.text(sale.quantity, 260, y, { width: 40 });
    pdfDoc.fontSize(17).text(sale.price, 300, y, { width: 90 });
    pdfDoc.fontSize(17).text(sale.total, 390, y, { width: 200 });
    productNo++;
  });
  pdfDoc
