...
function saveArray(e) {
  ...
  if (total) {
    ...
    sales.forEach((sale) => {
      document.getElementById("itemm").innerHTML += sale.item + "<br>";
      document.getElementById("quantityy").innerHTML += sale.quantity + "<br>";
      document.getElementById("pricee").innerHTML += sale.price + "<br>";
      document.getElementById("totall").innerHTML += sale.total + "<br>";
    });
