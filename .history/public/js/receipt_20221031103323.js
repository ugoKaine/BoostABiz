...
function saveArray(e) {
  ...
  if (total) {
    ...
    document.getElementById("itemm").innerHTML += sales.item + "<br>";
    document.getElementById("quantityy").innerHTML += sales.quantity + "<br>";
    document.getElementById("pricee").innerHTML += sales.price + "<br>";
    document.getElementById("totall").innerHTML += sales.total + "<br>";
